...
(async () => {
  const r = await runInfer(
    { prompt: 'What is 2+2? Answer with just the number.', max_tokens: 16, mode: 'route' },
    { freemem: () => os.freemem(),
