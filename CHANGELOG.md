...
- **Screened per turn, then in context.** Every history turn is classified alone
  ...
  otherwise, never served locally. Then the current prompt is classified in
