# 🧠 Prism MCP — O Palácio Mental para Agentes de IA
...
🌐 **Idioma:** [English](../../README.md) · [Español](README_es.md) · [Français](README_fr.md) · [Português](README_pt.md) · [Română](README_ro.md) · [Українська](README_uk.md) · [Русский](README_ru.md) · [Deutsch](README_de.md) · [日本語](README_ja.md) · [한국어](README_ko.md) · [中文](README_zh.md) · [العربية](README_ar.md)

> **Note:** This file is auto-generated from the [main README](../../README.md) by `scripts/generate_i18n.py`.
...
See the [Gemini Setup Guide](../SETUP_GEMINI.md) for the proven three-layer prompt architecture to ensure reliable session auto-loading.
...
![Mind Palace Dashboard — Neural Knowledge Graph, Project State, and Intent Health](../mind-palace-dashboard.png)

![Interactive Knowledge Graph — force-directed neural graph with click-to-filter and importance weighting](../knowledge-graph.jpg)

![Time Travel Timeline — browse and restore any historical memory version with diff comparison](../time-travel-timeline.jpg)

![Hivemind Radar — real-time multi-agent monitoring with heartbeat, task status, and activity feed](../hivemind-radar.jpg)

![Session Ledger — immutable audit trail of every agent decision across all projects](../session-ledger.jpg)
...
![prism scm search — semantic code search across repos](../scm_search_cli.jpg)

#### AI Review with HIPAA Check
![prism scm review — AI code review with HIPAA compliance](../scm_review_cli.jpg)

#### Security Scan
![prism scm scan — secret detection and Dockerfile analysis](../scm_scan_cli.jpg)
